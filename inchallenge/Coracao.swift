...
//        path.stroke()
    ...
    func getCoracao(originalRect: CGRect, scale: Double) -> UIBezierPath {
        ...
        path.moveToPoint(CGPointMake(scaledRect.midX, scaledRect.maxY))
        ...
        let dCurvePoint = CGPointMake(scaledRect.midX , scaledRect.origin.y + scaledRect.size.height)
        let dControlPointOne =  CGPointMake( scaledRect.origin.x + scaledRect.size.width ,  scaledRect.origin.y + scaledRect.height * 0.5 )
        let dControlPointTwo = CGPointMake(scaledRect.origin.x + scaledRect.width * 0.5, scaledRect.origin.y + scaledRect.size.height * 0.75)
